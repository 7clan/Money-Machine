 ...
 *   3. multi-chunk concat (3 chunks, total ~44s)
 *   4. non-integer-second audio duration (TTS producing 6.072s, 4.728s etc.)
 *
 * Assertion: final output video duration MUST contain the complete intended
 * timeline (within 1.0s tolerance). No truncation, no padding beyond encoder
 * overhead.
 *
